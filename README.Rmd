...
I've limited this list to open source tools where source code can be freely downloaded (i.e., you don't have to ask for
it). Even so, the list is certainly incomplete. If you're aware of something I've missed, let me know.
...
### *R* packages ###
  ...
  * *fix_align.R* automatically adjusts the vertical coordinate of each eye fixation in a multi-line reading experiment
    ...
    <http://people.umass.edu/eyelab/CohenBRM.pdf>.
