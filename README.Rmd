...
Before you dive into FDBeye, you might want to look at what else is available. See the list below. I've limited it to
tools where the source code can be freely downloaded (i.e., you don't have to ask for it). However, at least some of
projects do not carry an explicit Open Source License. Even given this constraint, the list is certainly incomplete. If
you know of something I've missed and it seems like it should be included, let me know. Better yet, fork this
