...
I've kept this list to tools where the source code can be freely downloaded (i.e., you don't have to ask for it), but
note that at least some of the tools lack an explicit Open Source License. Even so, the list is certainly incomplete. If
you know of something that seems like it should be included, let me know. Better yet, fork this repository, make the
...
### *R* packages ###
  ...
  * ***fix_align.R***: automatically adjusts the vertical coordinate of each eye fixation in a multi-line reading experiment
    ...
    fixated. At UMass <http://www.psych.umass.edu/PACLab/resources/>. Described in *Behav Res*:
