...
##' @TODO Find out if there is a way to interpret the filenames of bitmaps located in SRR EB script
##'     subdirectory "runtime/images" in a meaningful way. Most helpful would be to get a list of
##'     those files that SRR DataViewer knows to used as background images for a specific EDF file.
