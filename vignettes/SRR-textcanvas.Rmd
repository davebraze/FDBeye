...
most natural unit for regions of interest is that they correspond to
the individual words of a text. But it is often the case that mapping
gaze data onto multi-word regions that correspond to larger syntactic
or semantic constituents is also useful. The tools provided by, e.g.,
_Experiment Builder_ for redefining ROIs are tedious to use and not
very intuitive. Ours are better.
...
project as PNG bitmaps. Unfortunately, they are given rather cryptic
